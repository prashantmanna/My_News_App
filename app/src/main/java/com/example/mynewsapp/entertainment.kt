...
class entertainment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_entertainment, container, false)
        val recyclerView: RecyclerView = view.findViewById(R.id.recyclerEntertainment)
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            try {
                val response: Response<NewsResponse> = withContext(Dispatchers.IO) {
                    api.getCategory("in", "entertainment", 100, API_KEY)
                }
