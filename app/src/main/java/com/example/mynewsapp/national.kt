...
class national : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_national, container, false)
        val recyclerView: RecyclerView = view.findViewById(R.id.recyclerNational)
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            try {
                val response: Response<NewsResponse> = withContext(Dispatchers.IO) {
                    api.getCategory("in", "technology", 100, API_KEY)
                }
